...
class AT_UL_LabelTypeList(bpy.types.UIList):
...
# Register
def register():
    bpy.utils.register_class(AT_UL_LabelTypeList)
...
# Unregister
def unregister():
    bpy.utils.unregister_class(AT_UL_LabelTypeList)
